...
<div class="app-neutral-bg border-b border-slate-300 transition-colors dark:border-slate-700">
	<div class="mx-auto flex max-w-425 items-end gap-0.5 overflow-x-auto px-3 pt-2 text-sm">
		...
		<div
			class="ml-auto flex shrink-0 items-center gap-3 px-2 pb-1 text-xs text-slate-600 dark:text-slate-300"
		>
			...
			{:else}
				...
				>
					...
					<input
						...
						class="h-7 w-36 rounded border border-slate-400 bg-white px-2 text-xs text-slate-900 placeholder-slate-400 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100"
					/>
					<button
						type="submit"
